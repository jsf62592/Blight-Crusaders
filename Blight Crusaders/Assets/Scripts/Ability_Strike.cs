...
*/
	...
	void detectpara(GameObject dest){
		...
		xpara = (dest.transform.position.x-origposn.x)/30;
		ypara = (dest.transform.position.y-origposn.y)/30;
	}
...
*/
	...
	protected override void attachEffects(GameObject given_target){
		...
		prefab = (Transform) Instantiate(prefab, origposn, transform.rotation);// as Transform;
